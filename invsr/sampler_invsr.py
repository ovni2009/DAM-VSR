...
from invsr.utils import util_net
from invsr.utils import util_image
from invsr.utils import util_common
from invsr.utils import util_color_fix
...
from invsr.datapipe.datasets import create_dataset
from invsr.diffusers import StableDiffusionInvEnhancePipeline
...
class InvSamplerSR(BaseSampler):
    ...
    def inference_prepare(self, input):
        image = self.sample_func(input)
        return image
